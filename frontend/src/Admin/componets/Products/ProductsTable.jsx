          ...
          <Grid item xs={4}>
            <FormControl fullWidth>
              ...
              >
                ...
                <MenuItem value={"jacket"}>Men's Jacket</MenuItem>
                <MenuItem value={"activewear"}>Men's Activewear</MenuItem>
                <MenuItem value={"mens_kurta"}>Men's Kurta</MenuItem>
                <MenuItem value={"tshirt"}>Men's T-shirt</MenuItem>
                ...
                <MenuItem value={"kurtas"}>Kurta</MenuItem>
              </Select>
            </FormControl>
          </Grid>
          <Grid item xs={4}>
